 ...
 * https://cloud.tencent.com/developer/article/1719182
 * List<String> nodes = Arrays.asList("节点1", "节点1", "节点1", "节点1", "节点1", "节点1");
 ...
 * set.add(3);
 * set.add(4);
 * PointProcessBar.setColor();
 * PointProcessBar.show(nodes,set);
 * <p>
 * //        PointProcessBar.refreshTextList(nodes);
 * //        PointProcessBar.refreshSelectedIndexSet(set);
 *
 * @description: 节点进度条
 * @author: DMingO
 * @date: 2020/4/15
...
public class PointProcessBar extends View {
    ...
    private void initPaint() {
        ...
        mLinePaint.setColor(mColorUnselected);//未选中时线的颜色
//设置填充
...
//锯齿不显示
        ...
        mCirclePaint.setColor(mColorUnselected);//未选中时节点的颜色
//设置填充
...
//普通状态的文本 画笔
        ...
        mTextPaint.setColor(mColorTextUnselected);//文本颜色1
...
//绘制
    ...
    /**
     * 设置文本和节点颜色颜色 在show之前使用
     *
     * @param unselectedColor     未选中时的线，节点圆的颜色
     * @param selectedColor       选中时的颜色
     * @param textUnselectedColor 未选中的文字颜色
     */
    public void setColor(int unselectedColor, int selectedColor, int textUnselectedColor) {
        mColorUnselected = unselectedColor;
        mColorSelected = selectedColor;
        mColorTextUnselected = textUnselectedColor;
    }
}